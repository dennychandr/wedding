...
<body>
        ...
        <div class="slider_area_inner slider_bg_1 overlay2">
            <div class="slider_text text-center">
                <div class="text_inner">
                    <img src="{{ asset('') }}assets/img/banner/ornaments.png" alt="">
                    <h4>14 Jan 2020</h4>
                    <h3>Anjelina & Jack <br>
                        Wedding Ceremony</h3>
    ...
    <div class="weeding_countdown_area">
        <div class="flowaers_top d-none d-lg-block">
            <img src="{{ asset('') }}assets/img/banner/flower-top.png" alt="">
        </div>
        <div class="flowaers_bottom d-none d-lg-block">
            <img src="{{ asset('') }}assets/img/banner/flower-bottom.png" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center">
                        <img src="{{ asset('') }}assets/img/banner/flowers.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="{{ asset('') }}assets/img/story/1.png" alt="">
                        </div>
                        <span>Groom</span>
                        <h3>Jack Wonner</h3>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="{{ asset('') }}assets/img/story/2.png" alt="">
                        </div>
                        <span>Bride</span>
                        <h3>Anjelina Kona</h3>
                        <p>Many variations of passages of Lorem Ipsum available, but the majority have suffered
            ...
            <div class="row grid no-gutters">
                ...
                <div class="col-xl-4 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_7">
                        <a class="popup-image" href="{{ asset('') }}assets/img/gallery/7.png">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_8">
                        <a class="popup-image" href="{{ asset('') }}assets/img/gallery/8.png">
                        </a>
                    </div>
                </div>
                <div class="col-xl-5 col-md-6 col-lg-6 grid-item">
                    <div class="single_gallery gallery_imag_9">
                        <a class="popup-image" href="{{ asset('') }}assets/img/gallery/9.png"></a>
                    </div>
                </div>
            </div>
            <!-- <div class="grid row">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single_program program_bg_1 text-center">
                        <div class="program_inner ">
                            ...
                            <img src="{{ asset('') }}assets/img/program_details/ornaments.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4">
                ...
                <div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                    <div class="main_attending_area">
                        <div class="flower_1 d-none d-lg-block">
                            <img src="{{ asset('') }}assets/img/appointment/flower-top.png" alt="">
                        </div>
                        <div class="flower_2 d-none d-lg-block">
                            <img src="{{ asset('') }}assets/img/appointment/flower-bottom.png" alt="">
                        </div>
    ...
    <script>
        $('#clock').countdown('2025/02/08', function(event) {
