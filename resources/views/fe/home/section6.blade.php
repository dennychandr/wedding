<div class="section6">
    <div class="parallax mb-5">
        <div>
            <h1>Save the date</h1>
            <h2>-Two are better than one. We have found love in each other, now we invite you to share in our joy-</h2>
        </div>
        <div class="row holy-matrimony">
            <div class="col-12 backdrop">
                <div class="row d-flex align-items-center ">
                    ...
                    <div class="col-lg-6 col-sm-12 p-0 mt-3">
